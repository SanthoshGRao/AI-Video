...
INSERT INTO "property_templates" ("id", "slug", "name", "description", "icon", "focusAreas", "aiSystemPrompt", "scriptStrategy", "socialFormat", "ctaStyle", "hashtagStrategy", "sortOrder")
VALUES
('tpl_farmland', 'farmland', 'Farmland', 'Agricultural land with cultivation potential', 'TreePine', ARRAY['plot_size', 'water', 'soil', 'road_access', 'legal'], 'You are a real estate marketing expert specializing in farmland. Focus on soil quality, water sources, road access, legal clarity, and investment yield.', 'Open with location advantage, highlight acreage and water, emphasize RTC/legal, close with price and CTA.', 'Short punchy lines, emoji-light, location-first hooks for Instagram Reels.', 'Call now for site visit — limited plots', '#farmland #agriculture #investment #karnataka #realestate', 1),
('tpl_plantation', 'plantation', 'Plantation', 'Established or developable plantation property', 'Palmtree', ARRAY['tree_count', 'yield', 'irrigation', 'road_access'], 'Expert in plantation properties. Emphasize tree counts, crop type, drip irrigation, annual yield potential, and maintenance.', 'Lead with plantation type and tree count, irrigation systems, income potential, then location and price.', 'Visual tree-count hooks, yield numbers in captions.', 'Schedule plantation walkthrough', '#plantation #farm #coconut #arecanut #invest', 2),
