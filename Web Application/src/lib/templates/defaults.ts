export interface PropertyTemplateSeed {
  slug: string;
  name: string;
  description: string;
  icon: string;
...
export const DEFAULT_PROPERTY_TEMPLATES: PropertyTemplateSeed[] = [
  {
    slug: "farmland",
    name: "Farmland",
...
export const DEFAULT_PROMPT_CHIPS = [
  { id: "chip_1", label: "More Premium", prompt: "Make the tone more premium and upscale", category: "TONE" as const, icon: "✨", sortOrder: 1 },
  { id: "chip_2", label: "Investment Focus", prompt: "Emphasize ROI, appreciation, and investment returns", category: "TONE" as const, icon: "📈", sortOrder: 2 },
  { id: "chip_3", label: "Urgent Sale", prompt: "Add urgency — limited time, act fast messaging", category: "TONE" as const, icon: "🔥", sortOrder: 3 },
  { id: "chip_4", label: "NRI Investors", prompt: "Target NRI investors with diaspora-friendly language", category: "AUDIENCE" as const, icon: "🌍", sortOrder: 4 },
  { id: "chip_5", label: "Weekend Farmers", prompt: "Appeal to weekend farmers and hobby agriculturists", category: "AUDIENCE" as const, icon: "🌾", sortOrder: 5 },
  { id: "chip_6", label: "Shorter Script", prompt: "Reduce length by 30% while keeping key facts", category: "STYLE" as const, icon: "✂️", sortOrder: 6 },
  { id: "chip_7", label: "More Kannada", prompt: "Increase Kannada proportion in bilingual output", category: "STYLE" as const, icon: "🇮🇳", sortOrder: 7 },
  { id: "chip_8", label: "Highlight Water", prompt: "Emphasize water sources, borewell, and irrigation", category: "FEATURE" as const, icon: "💧", sortOrder: 8 },
  { id: "chip_9", label: "Highlight Trees", prompt: "Lead with plantation and tree count details", category: "FEATURE" as const, icon: "🌴", sortOrder: 9 },
  { id: "chip_10", label: "Stronger CTA", prompt: "End with a stronger call-to-action and contact prompt", category: "FEATURE" as const, icon: "📞", sortOrder: 10 },
];
