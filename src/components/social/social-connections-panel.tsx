    ...
    <div className={compact ? "space-y-3" : "space-y-4"}>
      {!compact && (
        <p className="text-sm text-slate-600">
          Connect social accounts once here. They stay linked for every project and auto-appear on the Final step.
        </p>
      )}
      ...
      <p className="text-xs text-slate-500">
        Full OAuth auto-upload requires platform API keys in your environment. Until then, connected accounts unlock one-click share with pre-filled captions and your exported video link.
      </p>
    </div>
  );
}
