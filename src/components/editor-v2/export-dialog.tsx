...
import { Download, FileVideo, CheckCircle2, Film, Layers, MonitorPlay } from "lucide-react";
...
export function ExportDialog({
  ...
  const { exportOpen, setExportOpen, projectName, aspect, elements, clips, settings, setSetting, background, tracks, transitions } = useEditor();
  ...
  const [resolutionTier, setResolutionTier] = useState<ResolutionTier>("1080");
