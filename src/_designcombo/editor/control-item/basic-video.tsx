...
import { ObjectFitControl } from "./common/object-fit";
import { MuteToggle } from "./common/mute-toggle";
import { DisplayDurationControl } from "./common/display-duration";
...
const BasicVideo = ({
  ...
  const components = [
    {
      key: "duration",
      component: <DisplayDurationControl trackItem={properties} />,
    },
    {
      key: "fit",
      component: <ObjectFitControl trackItem={properties} />,
    },
    {
      key: "mute",
      component: <MuteToggle trackItem={properties} />,
    },
    {
      key: "crop",
      component: (
